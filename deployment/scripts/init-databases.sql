-- Initialize all databases for the HIS-EMR platform
-- This script runs on first PostgreSQL startup

-- Enable pgvector extension (for AegisForge embeddings)
CREATE EXTENSION IF NOT EXISTS vector;

-- ============================================================
-- Database: his_system (for HIS-EMR Next.js app)
-- ============================================================
CREATE DATABASE his_system;

-- ============================================================
-- Database: n8n (for n8n workflow automation)
-- ============================================================
CREATE DATABASE n8n;

-- ============================================================
-- Database: aegisforge (default DB, already created by POSTGRES_DB)
-- AegisForge tables created via init-db.sql below
-- ============================================================

-- AegisForge schema in the default (aegisforge) database
-- Agent sessions
...
-- Task outcomes with pgvector embeddings
...
-- Grant permissions to the admin user on all databases
\c his_system;
